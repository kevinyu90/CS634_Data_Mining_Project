...
public class project_apriori_test {
...
//	            System.out.println();
//	            for(String s: candidateKeySet){
//	            	System.out.println(s+"   "+candidateSetMap.get(s));
//	            }
//	            System.out.println();
...
//	        dataList.add("1;2;3;");  
	        ...
	        dataList.add("B;C;D");
	        dataList.add("A;D");
	        dataList.add("A;B;C;D");
	        dataList.add("C;D");
	        dataList.add("C;D;E");
	        dataList.add("A;B");
	        
//	        dataList.add("Book;Cat;");
//	        dataList.add("Book;Cat;Dog;");
//	        dataList.add("Ace;Dog;");
//	        dataList.add("Ace;Book;Cat;Dog;");
//	        dataList.add("Cat;Dog;");
//	        dataList.add("Cat;Dog;");
//	        dataList.add("Ace;Book;");
	        ...
	        project_apriori_test apriori = new project_apriori_test();  
